...
jollibee = Restaurant('jollibee','filipino')
jollibee.describe_restaurant()

chowking = Restaurant('chowking','filipino-chinese')
chowking.describe_restaurant()

kuroda = Restaurant('kuroda','japanese')
kuroda.describe_restaurant()
