...
class Battery:
    ...
    def upgrade_battery(self):
        """Checks the battery size and sets the capacity"""
        if self.battery_size != 65:
            self.battery_size = 65
            print("The battery has been upgraded to max capacity! (65-kWh)")
        else:
            print("The battery is already at max capacity (65-kWh)!")
